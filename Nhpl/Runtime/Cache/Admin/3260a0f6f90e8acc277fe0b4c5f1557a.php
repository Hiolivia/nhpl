...
<div class="main-jsgl main-sc">
    <p class="attention"><span>注意：</span>这里显示酒店列表，目前比较简单，稍后深度二开</p>
    <div class="jsglNr">
        <div class="selectNr" style="margin-top: 0px; border-top:none;">
            ...
            <div class="right">
                <form class="search_form" method="post" action="<?php echo U('hotel/index');?>">
        ...
        <form method="post" action="<?php echo U('hotel/index');?>">
        ...
        <div class="tableBox">
            <table bordercolor="#dbdbdb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                ...
                <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                    ...
                    <?php echo BA('hotel/room',array("hotel_id"=>$var["hotel_id"]),'酒店房间','','remberBtn');?>
