    ...
    <div class="jsglNr">
        <form  target="baocms_frm" method="post">
            <div class="selectNr" style="border-top: 1px solid #dbdbdb;">
                <div class="left">
                    <?php echo BA('classify/create','','添加分类','load','',600,300);?>
                </div>
                <div class="right">
                    <?php echo BA('classify/update','','更新','list','remberBtn');?>
                </div>
            </div>
            <div class="tableBox">
                <table bordercolor="#dbdbdb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF; text-align:center;">
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr bgcolor="#f1f1f1" height="48px" style="font-size:14px; color:#545454; text-align:left; line-height:48px;">
                            <td style="padding-left:20px;"><?php echo ($var["classify_name"]); ?>(<?php echo ($var["id"]); ?>)</td>
                            ...
                            <td style="text-align: center;">
                                <?php echo BA('classify/edit',array("cate_id"=>$var["id"]),'编辑','load','remberBtn',600,300);?>
                                <?php echo BA('classify/delete',array("cate_id"=>$var["id"]),'删除','act','remberBtn');?>
                            </td>
