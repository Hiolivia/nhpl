...
class SettingAction extends CommonAction{
    ...
    public function mall(){
        if ($this->isPost()) {
            ...
            D('Setting')->cleanCache();
            $this->baoSuccess('上传设置成功', U('setting/mall'));
        } else {
            $this->display();
        }
    }
    ...
    public function housework(){
        if ($this->isPost()) {
            ...
            D('Setting')->cleanCache();
            $this->baoSuccess('家政设置成功', U('setting/housework'));
        } else {
            $this->display();
        }
    }
    public function updateapp()
    {
        if ($this->isPost()) {
            ...
            D('Setting')->cleanCache();
            $this->baoSuccess('更新设置成功', U('setting/updateapp'));
        } else {
            $this->display();
        }
    }
    ...
    public function goods(){
        if ($this->isPost()) {
            ...
            D('Setting')->cleanCache();
            $this->baoSuccess('商城设置成功', U('setting/goods'));
        } else {
            $this->display();
        }
    }
