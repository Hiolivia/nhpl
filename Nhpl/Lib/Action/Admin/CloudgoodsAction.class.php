...
class CloudgoodsAction extends CommonAction{
    private $create_fields = array(0 => 'title', 1 => 'shop_id', 2 => 'photo', 3 => 'city_id', 4 => 'area_id', 5 => 'price', 6 => 'join', 7 => 'max', 8 => 'settlement_price',9 => 'winning_user_id',10 => 'intro', 11 => 'type', 12 => 'thumb', 13 => 'details');
    private $edit_fields = array(0 => 'title', 1 => 'shop_id', 2 => 'photo', 3 => 'city_id', 4 => 'area_id', 5 => 'price', 6 => 'join', 7 => 'max', 8 => 'settlement_price',9 => 'winning_user_id',10 => 'intro', 11 => 'type', 12 => 'thumb', 13 => 'details');
    ...
    private function createCheck(){
		...
		$data['winning_user_id'] = (int) $data['user_id'];//指定中奖管理员
    ...
    public function edit($goods_id = 0){
        if ($goods_id = (int) $goods_id) {
            ...
            if ($this->isPost()) {
                ...
                $this->assign('thumb', $thumb);
                $this->assign('shop', d('Shop')->find($detail['shop_id']));
				$this->assign('users', D('Users')->find($detail['winning_user_id']));
                $this->assign('detail', $detail);
                $this->display();
            }
        } else {
