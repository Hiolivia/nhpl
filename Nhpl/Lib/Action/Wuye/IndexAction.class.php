...
$counts['order_type_5_is_pay'] = (int) D('Communityorderproducts')->where(array('type'=>5,'community_id' => $this->community_id,'is_pay'=>0))->sum('money');
	...
	$counts['order_0'] = (int) D('Communityorderproducts')->where(array('community_id' => $this->community_id,'is_pay'=>0))->sum('money');//未交费
	$counts['order_1'] = (int) D('Communityorderproducts')->where(array('community_id' => $this->community_id,'is_pay'=>1))->sum('money');//已交费
	//论坛
