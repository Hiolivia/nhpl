...
{
    private $create_fields = array('title', 'photo', 'full_price', 'reduce_price', 'expire_date', 'num', 'limit_num', 'intro','details');
    private $edit_fields = array('title', 'photo', 'full_price', 'reduce_price','expire_date', 'num', 'limit_num', 'intro','details');
