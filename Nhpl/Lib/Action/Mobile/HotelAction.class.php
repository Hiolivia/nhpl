...
class HotelAction extends CommonAction
{
    ...
    public function orderCreate()
    {
        ...
        if (IS_AJAX) {
            ...
            $data = array('room_id' => $room_id, 'num' => $num, 'price' => $detail['price'], 'user_id' => $this->uid, 'hotel_id' => $detail['hotel_id'], 'create_time' => NOW_TIME, 'create_ip' => get_client_ip());
    ...
    public function pay()
    {
        ...
        $this->assign('payment', D('Payment')->getPayments_booking());
